    ...
    <body
                            ...
                            <div class="app-navbar flex-shrink-0">
                                ...
                                <div class="app-navbar-item ms-1">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <select
                                            ...
                                            <option value=""></option>
                                            <option value="1" selected="selected">본사</option>
                                ...
                                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    <div
                                        ...
                                        data-kt-menu-attach="parent"
                                        data-kt-menu-placement="bottom-end">
                                        <img src="assets/media/avatars/user_empty.png" alt="user"/>
                                        <span class="fw-bold d-flex align-items-center fs-5">시스템관리자</span >
                                    </div>
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="symbol symbol-50px me-5">
                                                    <img alt="Logo" src="assets/media/avatars/user_empty.png"/>
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Username-->
                    ...
                    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                        ...
                        <div class="d-flex flex-column flex-column-fluid">
                            ...
                            <div id="spot_heado_toolbar" class="app-toolbar py-3 py-lg-6">
                                ...
                                <div id="spot_heado_container" class="app-container d-flex flex-stack">
                                    <!--begin::Page title-->
                                    <div
                                        ...
                                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                            ...
                                            <li class="breadcrumb-item text-muted">
                                                <a href="#" class="text-muted text-hover-primary">학생 관리</a >
                                            </li>
                                            <!--end::Item-->
                                            <!--begin::Item-->
                                            ...
                                            <!--end::Item-->
                                            <!--begin::Item-->
                                            <li class="breadcrumb-item text-muted">학생정보 관리</li>
                                            <!--end::Item-->
                                        </ul>
                                        <!--end::Breadcrumb-->
                                    </div>
                                            ...
                                            <div class="row gy-5 g-xl-10">
                                                ...
                                                <div class="col-md-6 col-xl-12 mb-xl-10">
                                                    ...
                                                    <div class="card card-flush h-xl-100 card__left">
                                                        ...
                                                        <!--end::Header-->
                                                        <!--begin::Search-->
                                                        <div class="d-flex align-items-center position-relative my-1 card_l_h_sch">
                                                                ...
                                                                <table
                                                                    ...
                                                                    <thead class="fs-7 text-gray-400 text-uppercase">
                                                                        <tr class="fw-bold text-muted">
                                                                            ...
                                                                            <th class="min-w-100px">학생명/학교</th>
                                                                            <th class="min-w-50px text-end">상태</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <!--end::Head-->
                                                                    <!--begin::Body-->
                                                                    <tbody class="fs-6" id="studentsList"></tbody>
                                                                    <!--end::Body-->
                                                                </table>
                                                                <!--end::Table-->
                                                            </div>
                                            ...
                                            <div class="card card-flush h-xl-100 card__right">
                                                ...
                                                <div class="card-header py-7">
                                                    ...
                                                    <div
                                                        ...
                                                        <!--end::Tab item-->
                                                        <!--begin::Tab item-->
                                                        <!-- <div class="fs-4 fw-bold text-muted pb-3 cursor-pointer right__tab_btn
                                                        right__tab02_btn on" data-kt-table-widget-3="tab"
                                                        data-kt-table-widget-3-value="Pending">학부모정보</div> -->
                                                        <!--end::Tab item-->
                                                    </div>
                                                    <!--end::Tabs-->
                                                </div>
                                                ...
                                                <div class="card-body pt-1 card_right_body right__tab_con right__tab02_con on">
                                                    ...
                                                    <div class="row mb-5">
                                                        ...
                                                        <div class="col-md-6 fv-row ">
                                                            ...
                                                            <select
                                                                ...
                                                                class="form-select form-select-solid"
                                                                onchange="handleOnChangeBrand(this)"></select>
                                                        </div>
                                                        <!--end::Col-->
                                                        <!--begin::Col-->
                                                        <div class="col-md-6 fv-row">
                                                            <!--end::Label-->
                                                            <label class="required fs-5 fw-semibold mb-2">지점명</label >
                                                            <!--end::Label-->
                                                            <!--end::Input-->
                                                            <!-- <input type="text" class="form-control" value="" name="branchName" id =
                                                            "branchName" /> -->
                                                            <select
                                                                name="position"
                                                                id="branch"
                                                                ...
                                                                data-placeholder="Select a position..."
                                                                class="form-select form-select-solid"
                                                                onchange="handleOnChangeBranch(this)"></select>
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Col-->
                                                    </div>
                                                    <div class="row mb-5">
                                                        ...
                                                        <div class="col-md-6 fv-row">
                                                            <!--begin::Label-->
                                                            <label class="required fs-5 fw-semibold mb-2">이름</label >
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                        ...
                                                        <div class="col-md-6 fv-row">
                                                            <!--end::Label-->
                                                            <label class="required fs-5 fw-semibold mb-2">아이디</label >
                                                            <!--end::Label-->
                                                            <!--end::Input-->
                                                            <input
                                                                type="text"
                                                    ...
                                                    <div class="row mb-5">
                                                        ...
                                                        <div class="col-md-6 fv-row">
                                                            <!--begin::Label-->
                                                            <label class="required fs-5 fw-semibold mb-2">비밀번호</label >
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input
                                                                type="password"
                                                        ...
                                                        <div class="col-md-6 fv-row">
                                                            <!--end::Label-->
                                                            <label class="required fs-5 fw-semibold mb-2">비밀번호 확인</label >
                                                            <!--end::Label-->
                                                            <!--end::Input-->
                                                            <input
                                                                type="password"
                                                    ...
                                                    <div class="row mb-5">
                                                        ...
                                                        <div class="col-md-6 fv-row">
                                                            <!--end::Label-->
                                                            <label class="fs-5 fw-semibold mb-2">이메일</label >
                                                            <!--end::Label-->
                                                            <!--end::Input-->
                                                    ...
                                                    <div class="row mb-5">
                                                        ...
                                                        <div class="col-md-12 fv-row">
                                                            <!--begin::Label-->
                                                            <label class="fs-5 fw-semibold mb-2">주소</label>
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input
                                                                type="text"
                                                    ...
                                                    <div class="row mb-5 ">
                                                        ...
                                                        <div class="col-md-6 fv-row">
                                                            <!--begin::Label-->
                                                            <label class="fs-5 fw-semibold mb-2">학교</label >
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="text" class="form-control " value="" name="school" id="school"/>
                                                        </div>
                                                        <div class="col-md-6 fv-row ">
                                                            <!--begin::Label-->
                                                            <label class="required fs-5 fw-semibold mb-2">학년</label >
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                    ...
                                                    <div class="row mb-5 ">
                                                        ...
                                                        <div class="col-md-6 fv-row">
                                                            <!--begin::Label-->
                                                            <label class="fs-5 fw-semibold mb-2">학습실</label >
                                                            <select
                                                                id="room"
                                                                name="position"
                                                                data-control="select2"
                                                        ...
                                                        <div class="col-md-6 fv-row ">
                                                            <!--begin::Label-->
                                                            <label class="required fs-5 fw-semibold mb-2">좌석번호</label >
                                                            <input
                                                                type="text"
                                                                class="form-control "
                                                                value=""
        ...
        <script>
            ...
            $(document).ready(function () {
                $.ajax({
                    url: "https://farm01.bitlworks.co.kr/api/v1/users/students", type: "get", contentType: "application/json",
                    // data:studentData,
                    datatype: "JSON",
            ...
            <tr class="student_${parseInt(row) + 1}" id = ${row_data.id}>
              ...
              <td class="text-end" id ="statusUse" >
                <span class="badge badge-light-success fw-bold px-4 py-3">${row_data.status}</span>
                    ...
                    // if(row_data.status == "사용"){   newDiv.innerHTML += `   <tr
                    // class="student_${parseInt(row) + 1}" id = ${row_data.id}>     <td>
                    // ${parseInt(row) + 1} </td>     <td class="n_empty"></td>     <td
                    // class="text-muted fw-semibold">       <div class="d-flex flex-stack">
                    // <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    // <div class="flex-grow-1 me-2">             <a
                    // href="/metronic8/demo1/../demo1/pages/user-profile/overview.html"
                    // class="text-gray-800 text-hover-primary fs-6 fw-bold"
                    // >${row_data.branch.name}</a             >           </div>         </div>
                    // </div>     </td>     <td>                               <!--begin::Section-->
                    // <div                               class="d-flex align-items-center
                    // flex-row-fluid flex-wrap"                             >
                    // <!--begin:Author-->                               <div class="flex-grow-1
                    // me-2">                                 <a
                    // href="/metronic8/demo1/../demo1/pages/user-profile/overview.html"
                    // class="text-gray-800 text-hover-primary fs-6 fw-bold"
                    // >${row_data.realName}</a                                 >
                    // <span                                   class="text-muted fw-semibold d-block
                    // fs-7"                                   >${row_data.school}
                    // <span>${row_data.grade}</span></span                                 >
                    // </div>                               <!--end:Author-->
                    // </div>                             <!--end::Section-->
                    // </td>     <td class="text-end" id ="statusUse" >       <span class="badge
                    // badge-light-success fw-bold px-4 py-3">${row_data.status}</span>     </td>
                    // </tr>` }else if(row_data.status == "대기"){   newDiv.innerHTML += `   <tr
                    // class="student_${parseInt(row) + 1}" id = ${row_data.id}>     <td>
                    // ${parseInt(row) + 1} </td>     <td class="n_empty"></td>     <td
                    // class="text-muted fw-semibold">       <div class="d-flex flex-stack">
                    // <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                    ...
                    // </div>                               <!--end:Author-->
                    // </div>                             <!--end::Section-->
                    // </td>     <td class="text-end" id ="statusWait" >       <span class="badge
                    // badge-light-warning fw-bold px-4 py-3">${row_data.status}</span>     </td>
                    // </tr>` }else{   newDiv.innerHTML += `   <tr class="student_${parseInt(row) +
                    // 1}" id = ${row_data.id}>     <td> ${parseInt(row) + 1} </td>     <td
                    // class="n_empty"></td>     <td class="text-muted fw-semibold">       <div
                    // class="d-flex flex-stack">         <div class="d-flex align-items-center
                    // flex-row-fluid flex-wrap">           <div class="flex-grow-1 me-2">
                    // <a
                    // href="/metronic8/demo1/../demo1/pages/user-profile/overview.html"
                    // class="text-gray-800 text-hover-primary fs-6 fw-bold"
                    // >${row_data.branch.name}</a             >           </div>         </div>
                    ...
                    // </div>                               <!--end:Author-->
                    // </div>                             <!--end::Section-->
                    // </td>     <td class="text-end" id ="statusStop" >       <span class="badge
                    // badge-light-danger fw-bold px-4 py-3">${row_data.status}</span>     </td>
                    // </tr>` } if(row_data.status == "사용"){   console.log("1")
                    // document.getElementById("statusUse").style.display = "";
                    // document.getElementById("statusWait").style.display = "none";
                    // document.getElementById("statusStop").style.display = "none"; }else
                    // if(row_data.status == "대기"){   console.log("2")
                    // document.getElementById("statusUse").style.display = "none";
                    // document.getElementById("statusWait").style.display = "";
                    // document.getElementById("statusStop").style.display = "none"; }else if
                    // (row_data.status == "삭제"){   console.log("3")
                    // document.getElementById("statusUse").style.display = "none";
                    // document.getElementById("statusWait").style.display = "none";
